    ...
    <div id="test1234" class="task_overlay_card_ctn single_task_ctn">
              <div class="overlay_task_header">
                      <div class="single_task_header_category_and_close">
                          ...
                          <diy onclick="clickCloseTaskOverlay()" id="close_task_overlay" class="close_task_overlay">
              ...
              <div class="overlay_task_main"> 
                  ...
                  <div class="single_task_delete_or_edit_ctn">
                      <div class="delete_or_edit_buttons">
                          ...
                          <div onclick="openChangeValueTask(${keyToOpen})" id="id="btnEdt${keyToOpen}" class="delete_or_edit_button">
