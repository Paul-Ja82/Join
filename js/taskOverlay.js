            ...
            <div class="overlay_task_header">
             ...
             <div class="overlay_task_main"> 
                ...
                <div class="single_task_assigned_to_ctn">
                    ...
                    <div id="single_task_contacts_ctn${allTasks[keyToOpen].single_ID}" class="single_task_contacts_ctn">
                    ${assignedToContacts}
                    </div>
                </div>
                ...
                <div class="single_task_delete_or_edit_ctn">
                    <div class="delete_or_edit_buttons">
                        ...
                        <div onclick="" id="id="btnEdt${keyToOpen}" class="delete_or_edit_button">
