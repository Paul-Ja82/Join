...
function checkTask(e) {
    ...
    if (container) {
        console.log('Geklickt auf Container mit ID:', container.id);
...
function fillTaskOverlay(allTasks, keyToOpen) {
    console.log(keyToOpen)
    ...
    document.getElementById(`task_overlay_ctn`).innerHTML = `
       <div class="task_overlay_card_ctn single_task_ctn">
            ...
            <div class="overlay_single_task_description">Define CSS naming conventions and structure.</div>
            <div class="single_task_due_date_ctn">
                <div class="single_task_line_header">Due date:</div>
                <div class="single_task_line_date">10/05/2023</div>
            </div>
            <div class="single_task_pritoity_ctn">
                <div class="single_task_line_header">Priority:</div>
                <div class="single_task_line_priority">
                    <span>Medium</span>
                    <img src="./assets/img/prio_medium.png" alt="Orangenes Gleichzeichen">
                </div>
            </div>
            <div class="single_task_assigned_to_ctn">
                ...
                <div class="single_task_contacts_ctn">
                    <div class="single_task_single_contact">
                        <div class="task_contact_name_icon">SM</div>
                        <div class="task_contact_name">Sofia Müller (You)</div>
                    </div>
                    <div class="single_task_single_contact">
                        <div class="task_contact_name_icon">BZ</div>
                        <div class="task_contact_name">Benedikt Ziegler</div>
                    </div>
                </div>
            </div>
            <div class="single_task_subtasks_ctn">
                ...
                <div class="single_task_subtask">
                    <input type="checkbox" name="subtask_done" id="subtask1">
                    <label for="subtask1">
                ...
                <div class="single_task_subtask">
                    <input type="checkbox" name="subtask_done" id="subtask2">
                    <label for="subtask2"> 
                        <div class="subtask_checkbox">
                            <div class="checkbox_empty">
                                <svg id="checkbox_empty" width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="single_task_delete_or_edit_ctn">
                <div class="delete_or_edit_buttons">
                    <div id="task_overlay_edit_task_btn" class="delete_or_edit_button">
                    ...
                    <div id="task_overlay_delete_task_btn" class="delete_or_edit_button">
...
function checkIndexOfAllTasks(clickedSingleID, allTasks, allKeys) {
    ...
    for (let i = 0; i < allKeys.length; i++) {
        let key = allKeys[i]
        console.log(allTasks[key].single_ID);
    ...
    console.log(indexToOpen, keyToOpen);
    
    fillTaskOverlay(allTasks, keyToOpen)
}
